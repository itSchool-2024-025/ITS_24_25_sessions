...
def home():
    ...
    if not current_user.is_authenticated:
        ...
        return render_template("home.html", inventory=inventory, message=message)
        ...
        if current_user.is_authenticated:
            ...
            # Item can be released only if booked by same user
            elif item.inventory_booked == "In Use" and item.user_id == current_user.user_name:
                # Free the item
                ...
                message = " Item is already In Use by other user"
            ...
            return redirect(url_for('main.login', message=message))  # refresh page after update
...
def register():
    ...
    if request.method == 'POST':
        ...
        print(f"Debug1- Register- User: {user_name}, Email: {user_email} , ")
